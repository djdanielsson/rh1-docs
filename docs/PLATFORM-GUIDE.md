...
controller_projects_plat_configure_database:
  - name: "plat_database_config_playbooks"
    ...
    credential: "plat_scm_git_github"
    timeout: 0
...
controller_templates_plat_configure_database:
  - name: "plat_configure_database"
    description: "Configure PostgreSQL database servers"
    job_type: "run"
...
controller_credentials_all:
  ...
  - name: "plat_scm_git_github"          # Referenced in project

# inventories.yml - Target inventories
controller_inventories_all:
  - name: "plat_databases"               # Referenced in JT
```
