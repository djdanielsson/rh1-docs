...
./scripts/validate-manifest-schema.py releases/release-v1.0.0.yaml --verbose

# Use custom schema
./scripts/validate-manifest-schema.py releases/release-v1.0.0.yaml --schema custom-schema.json
```
...
manifest_path = Path("releases/release-v1.0.0.yaml")
...
metadata:
  name: release-v1.0.0          # Pattern: release-*
...
Manifest: releases/release-v1.0.0.yaml
